 ...
 * @version  1.0
 */
@WebServlet(urlPatterns="/android/viewMyBid.jsp")
public class ViewMyBidServlet extends BaseServlet
{
    /**
	 * 
	 */
		...
		throws IOException , ServletException
	{
		...
		CallingManager callingManager = (CallingManager)getCtx().getBean("mgr");
		
		List<BidBean> bids = callingManager.getBidByUser(userId);
